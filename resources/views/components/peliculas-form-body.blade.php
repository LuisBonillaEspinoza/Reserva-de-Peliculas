...
<div class="row g-3">
  <div class="col-sm-6">
    ...
    <input type="text" class="form-control {{ $errors->has('nombre_pelicula') ? ' is-invalid' : '' }}" id="name_pelicula" placeholder="" value="{{ $errors->has('nombre_pelicula') ? '': old('nombre_pelicula',$peliculas->nombre_pelicula) }}" name="nombre_pelicula">
  ...
  <div class="col-sm-6">
    ...
    <input type="text" class="form-control {{ $errors->has('descripcion_pelicula') ? ' is-invalid' : '' }}" id="descrip_pelicula" placeholder="" value="{{ $errors->has('descripcion_pelicula') ? '': old('descripcion_pelicula',$peliculas->descripcion_pelicula) }}" name="descripcion_pelicula">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control {{ $errors->has('precio_pelicula') ? ' is-invalid' : '' }}" id="pre_pelicula" value="{{ $errors->has('precio_pelicula') ? '': old('precio_pelicula',$peliculas->precio_pelicula) }}" name="precio_pelicula">
  ...
  <div class="col-md-6">
    ...
    <select class="form-select" id="cat_pelicula" name="categoria_pelicula">
        ...
        @foreach ($categorias as $cat)
            <option value="{{ $cat->id }}" @selected(old('categoria_pelicula',$peliculas->categoria_pelicula) == $cat->id)>{{ $cat->nombre_categoria }}</option>
        @endforeach
      </select>
  ...
  <div class="col-md-12">
    ...
    <input class="form-control {{ $errors->has('file_pelicula') ? ' is-invalid' : '' }}" type="file" id="peli_file" name="file_pelicula">  
